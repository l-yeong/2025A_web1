package example.day02_20250731._1어노테이션;
...
class SubClass extends SuperClass{ //하위클래스 //자식
    ...
    //오버라이딩 이란? 부모로부터 물려받은 메소드를 커스텀/재정위 하는 행위
...
class TestClass1{
    ...
    public void method3(){
        //value1(); // [X]: 런타임(실행중) 할때 사용하므로 직접적인 코드로 주입 받는게 아니다
        // 즉] 프로그램 실행시 method3() 메소드가 실행되면 value1() 메소드도 같이 실행 된다.
    }// method3 end
}// TestClass1 end
